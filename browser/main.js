...
var redirectIfAuthenticatedGuard = () => {
  const authService = inject(AuthService);
  const router = inject(Router);
...
var routes = [
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-QTJ76N22.js").then((module) => module.LoginComponent)
  },
  {
    path: "dashboard",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-BPC5HNAA.js").then((module) => module.DashboardComponent)
  },
  {
    path: "**",
    redirectTo: "dashboard"
